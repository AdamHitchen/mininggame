...
public class TerrainGenerator {
    ...
    public void initializeChunks() throws SlickException, IOException {
    ...
    public void setLoadedChunks() throws SlickException, IOException {
    ...
    public void update(GameContainer gc, int arg1) throws SlickException, IOException {
        setLoadedChunks();
        for (int i = 0; i < chunksToLoad; i++) {
    ...
    private void generateWorld() throws IOException, SlickException {
        ...
        for (int i = 0; i < maxX; i++) {
            for (int y = 0; y < maxY; y++) {
                if (y < worldRow[i] - 4 && (noiseTest[i][y] == 3 || noiseTest[i][y] == 5 || noiseTest[i][y] == 6 || noiseTest[i][y] == 7 || noiseTest[i][y] == 8 || noiseTest[i][y] == 4 || noiseTest[i][y] == 5 || noiseTest[i][y] == 10)) {//values to set to blank space ^^^^^^^^^^^^^^^^^^^^^^
                    worldArray[i][y] = 0;
                    //generate chests//
                    if (i > 0 && y > 0) if (worldArray[i][y - 1] == 3) {
                        caveSurfaces++;
                        if (random.nextInt(300) == 90) {
                            worldArray[i][y] = 6;
                            chestsGenerated++;
                        }
                    }
