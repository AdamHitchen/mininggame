...
public class tarpey {
    ...
    public void update(GameContainer gc, int arg0) throws SlickException {
        loaded = position.x > game.cam.camPosX() - 64 && position.x < game.cam.camPosX() + game.getWidth() + 64 &&
        ...
        if (loaded) {
            ...
            tarpeyRot.x = playerPos.x - position.x;
            tarpeyRot.y = playerPos.y - position.y;
